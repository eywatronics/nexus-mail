...
| Özellik | Ne yapar | Yol | KT |
|---|---|---|---|
| Matrix | Homeserver'a bağlan, oda ve DM | `chat/protocols/matrix/matrix.sys.mjs` | M15 |
| Matrix uçtan uca şifreleme | | `chat/protocols/matrix/matrixAccount.sys.mjs` | M15 |
| Matrix cihaz/kullanıcı doğrulama | SAS/emoji doğrulama | `mail/components/im/content/verify.xhtml` | M15 |
| XMPP | Roster, 1:1, MUC | `chat/protocols/xmpp/xmpp.sys.mjs` | M15 |
| XMPP SASL (SCRAM-SHA-1/256) | | `chat/protocols/xmpp/xmpp-authmechs.sys.mjs` | M15 |
| OTR şifreleme | 1:1 konuşmalar için | `chat/modules/OTR.sys.mjs` | M15 |
| OTR doğrulama | Paylaşılan sır / soru-cevap / parmak izi | `chat/content/otr-auth.xhtml` | M15 |
| Konuşma günlüğü | Yerel JSON, otomatik temizleme | `chat/components/src/logger.sys.mjs` | M15 |
| Kişi listesi, gruplar, durum | | `chat/components/src/imContacts.sys.mjs` | M15 |
| Mesaj temizleme | Gelen mesajın güvenli HTML'i | `chat/modules/imContentSink.sys.mjs` | M15 |
| Bildirimler | | `mail/components/im/modules/chatNotifications.sys.mjs` | M15 |
